  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6 bg-black/70 text-white">
        ...
        <p className="max-w-3xl text-lg md:text-2xl leading-relaxed mb-8 font-semibold">
          They didn’t just take our kids. They took our voice, our rights, our dignity—and called it protection.<br />
          This is not safety. This is not justice. This is legalized kidnapping backed by dollars and silence.<br />
          They call it the system. We call it what it is: <strong>theft</strong>.
        </p>
        <a
          href="/who-we-are"
